...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    if(isset($_POST['submit'])){
      ...
      $pc = $_POST['pc'];
      $sql ="INSERT INTO `tb_customers`(`id_customer`, `fname`, `mname`, `lname`, `phone`, `email`, `address`, `city`, `country`, `postal_code`)
              VALUES (null,'$fname','$mname','$lname','$phone','$email','$address','$city','$country','pc')";
